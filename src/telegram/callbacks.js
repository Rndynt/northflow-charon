...
export async function handleCallback(query) {
  ...
  if (kind === 'closeall') {
    if (id === 'ask') return askCloseAllConfirmation(chatId, query);
    if (id === 'do') return closeAllOpenPositions(chatId, query);
    if (id === 'cancel') return sendFilteredPositions(chatId, 'open', query);
  }
